...
/**
 * Press motion matches `Button` and `PillTabs` so every control in the app shares
 * one feel. The selected item also uses `primary` rather than the pale `accent`
 * default, so an active segment reads as clearly as an active pill tab.
 */
  ...
  return (
    ...
    >
      <animated.span
        ...
        style={{ ...style, scale: pressStyle.scale }}
      >
        {children}
      </animated.span>
    </ToggleGroupPrimitive.Item>
